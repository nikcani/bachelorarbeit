...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/active_filter_filament}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/active_filter_nova}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/finished_flight_nova}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/finished_flight_filament}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/station_fields_nova}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.20]{assets/station_fields_filament}
\end{figure}
