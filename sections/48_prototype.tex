...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.15]{assets/active_filter_filament}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.15]{assets/active_filter_nova}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.15]{assets/finished_flight_filament}
\end{figure}
...
\begin{figure}[h!]
    ...
    \includegraphics[scale=0.15]{assets/finished_flight_nova}
\end{figure}
