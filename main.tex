...
\begin{document}
    ...
    \include{sections/01_non_disclosure}
    ...
    \input{sections/20_foundation}
    \input{sections/30_analyses}
    \input{sections/40_conception}
    \input{sections/50_implementation}
    \input{sections/60_results_reflection_evaluation}
    \input{sections/70_conclusion_and_prospects}
